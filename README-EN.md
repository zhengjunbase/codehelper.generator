...
- method name generated mapper sql not depend on codehelper.properties, it will auto find the mapper xml for you. so you can use it on an existing mybatis project as well.
