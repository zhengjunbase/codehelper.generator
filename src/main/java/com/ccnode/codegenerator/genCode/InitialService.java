    ...
    public static GenCodeResponse initPojos(GenCodeResponse response) {
        ...
        for (String pojoName : response.getRequest().getPojoNames()) {
            ...
            try{
                ...
                onePojoInfo.setFullDaoPath(genPath(response, pojoDirPath, config.getDaoDir(), pojoName,config.getDaoSuffix() + ".java"));
                onePojoInfo.setFullServicePath(genPath(response, pojoDirPath, config.getServiceDir(), pojoName,config.getServiceSuffix() + ".java"));
                onePojoInfo.setFullSqlPath(genPath(response, pojoDirPath, config.getSqlDir(), pojoName,".sql"));
                onePojoInfo.setFullMapperPath(genPath(response, pojoDirPath, config.getMapperDir(), pojoName,config.getMapperSuffix() + ".xml"));
