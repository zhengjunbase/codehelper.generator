...
public class OnePojoInfoHelper {
    ...
    public static void deduceDaoPackage(OnePojoInfo onePojoInfo, GenCodeResponse response){
        ...
        String deducePackage = GenCodeUtil
                .deducePackage(StringUtils.defaultIfEmpty(response.getCodeConfig().getDaoDir(),onePojoInfo.getPojoDirPath()) ,onePojoInfo.getPojoPackage());
